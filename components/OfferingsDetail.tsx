...
const offerings = [
  {
    ...
    description:
      "Thoughtfully chosen textiles and essentials that shape your sleep environment, from what you sleep on to what surrounds you through the night.",
    icon: (
      <>
  ...
  },
  {
    ...
    description:
      "Guidance and support for anyone looking to understand and improve how they sleep, built around real needs rather than generic advice.",
    icon: (
      <>
  ...
  },
  {
    ...
    description:
      "Moments designed to help you slow down, disconnect, and rest, beyond what any single product can offer on its own.",
...
export default function OfferingsDetail() {
  return (
    <section className="bg-parchment pb-[140px] pt-[150px] text-ink">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          {offerings.map((item, index) => (
            ...
            >
              ...
              <p className="max-w-[320px] text-[14.5px] leading-[1.75] text-taupe">
                {item.description}
              </p>
            </div>
          ))}
